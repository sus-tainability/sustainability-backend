    ...
    return await queryInterface.bulkInsert('events', [
      {
        ...
        description:
          "Join us in raising awareness for red pandas by creating a social media post with the hashtags #savingredpandas and #BetterEarth. Let's use the power of social media to help protect these amazing animals!",
      ...
      },
      {
        name: 'Eat Vegetarian',
        description:
          "By consuming vegetarian meals, even if it's just one day a week, we can help reduce the emission of greenhouse gases and lessen the impact of climate change on the planet.",
      ...
      },
      {
        ...
        description:
          'Bringing a reuseable bag with you wherever you go is a simple yet effective way to help the planet and support the survival of these incredible animals.',
        validationText: 'Verify if this is a reuseable bag',
        carbonSave: 500, // TODO- Will update this with new data
        eventDuration: 4,
        reward: 500,
        requiredAssets: 5,
        imageUrl: 'https://cdn-icons-png.flaticon.com/512/2784/2784495.png',
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        ...
        description:
          'Appliances with higher water efficiency ratings use less water and can help us conserve this precious resource.',
